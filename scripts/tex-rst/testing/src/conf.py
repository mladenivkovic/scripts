...
\\newcommand{\\zh}[1]{\\cdot 10^{#1}} %mal zehn hoch
...
#  import caktus_theme
#  html_theme = 'caktus'
#  html_theme_path = html_theme_path = [caktus_theme.get_theme_dir()]
#  html_sidebars = caktus_theme.default_sidebars()

#  import epfl_theme
#  html_theme = 'epfl'
#  html_theme_path = html_theme_path = [epfl_theme.get_theme_dir()]
...
latex_documents = [
    (master_doc, 'Glossary.tex', 'Glossary',
     'Mladen Ivkovic', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'Glossary', 'Glossary',
     author, 'Glossary', 'One line description of project.',
     'Miscellaneous'),
]
